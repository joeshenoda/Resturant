@component('employee.components.page')
    ...
    <form novalidate class="bs-validate d-block mb-7" method="post" action="{{route('employee.employee.profile', $employee->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="col my-3">
                                ...
                                <div class="input-group-over">
                                    ...
                                    <div class="form-label-group">
                                        <input required  placeholder="Email Address" id="email" name="email" type="email" class="form-control" value="{{$employee->email}}">
                        ...
                        <div class="row gutters-sm d-flex align-items-center">
                            ...
                            <div class="col-12 col-md-12">
                                ...
                                <div class="form-label-group mt-3">
                                    <input required placeholder="First Name" id="name" name="name" type="text" value="{{$employee->name}}" class="form-control">
...
<!--
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-label-group mt-3">
                                    <input required placeholder="First Name" id="phone" name="phone" type="text" value="{{$employee->phone}}" class="form-control">
                                    <label for="account_first_name"> {{__('Phone')}}</label>
                                </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-label-group mt-3">
                                    <input required placeholder="First Name" id="national_id" name="national_id" type="text" value="{{$employee->national_id}}" class="form-control">
                                    <label for="account_first_name"> {{__('National ID')}}</label>
                                </div>
                            ...
                            <div class="col-12 col-md-12">
                                ...
                                <div class="form-label-group mt-3">
                                    <input required placeholder="First Name" id="address" name="address" type="text" value="{{$employee->address}}" class="form-control">
                                    <label for="account_first_name"> {{__('Address')}}</label>
                                </div>
