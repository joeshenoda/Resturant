            ...
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-clean dropdown-menu-hover" aria-labelledby="mainNavHome">
                        ...
                        <li class="dropdown-item">
                            <a class="dropdown-link" href="{{route('employee.user.index')}}">
                                <i class="fi fi-user-plus"></i>
                                {{__('Show')}} {{__('Users')}}
                            </a>
                        </li>
                        <li class="dropdown-item">
                            <a class="dropdown-link" href="{{route('employee.user.create')}}">
                                <i class="fi fi-user-plus"></i>
                                {{__('Create')}} {{__('User')}}
                            </a>
                        </li>
                        <li class="dropdown-item">
                            <a class="dropdown-link" href="{{route('employee.user.edit')}}">
                        ...
                        <li class="dropdown-item">
                            <a class="dropdown-link" href="{{route('employee.user.delete')}}">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-clean dropdown-menu-hover" aria-labelledby="mainNavHome">
                        ...
                        <li class="dropdown-item">
                            <a class="dropdown-link" href="{{route('employee.order.index')}}">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-clean dropdown-menu-hover" aria-labelledby="mainNavHome">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link"  href="{{route('employee.visitors')}}">
                                <i class="fi fi-users"></i>
                               {{__('Show')}} {{__('Visitors')}}
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link"  href="{{route('employee.table.check')}}">
                ...
                <ul class="dropdown-menu dropdown-menu-clean dropdown-menu-hover" aria-labelledby="mainNavHome">
                    ...
                    <li class="dropdown-item">
                        ...
                        @if(Auth::guard('employee')->check())
                            <form action="{{route('employee.employee.logout')}}" method="post" class="">
                                @csrf
