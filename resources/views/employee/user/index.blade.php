            ...
            <div class="portlet">
                ...
                <div class="portlet-header border-bottom">
                    ...
                    <div class="text-center" >
                        ...
                        <span > {{__('Total')}}      <span class=" badge badge-danger" > {{\App\Models\User::all()->count()}}</span></span>
                ...
                <div class="portlet-body">
                    <div class="container py-6">
                        ...
                        <div class="card-header" style="width: auto">
                            ...
                            <a href="{{route('employee.user.create')}}" class="js-ajax btn btn-sm btn-success btn-pill px-2 py-1 fs--15 "><i class="fa fa-plus"></i><span >{{__('Create')}}</span></a>
                        </div>



                        <form action="{{route('employee.user.destroy_all')}}" id="form_data" class="d-inline" method="post">
                            @csrf
                            ...
                            <div class="table-responsive">
                                <table class="table table-framed dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-gray-500 font-weight-normal fs--14 w--200"> {{__('Phone')}} </th>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <label class="form-checkbox form-checkbox-primary float-start">
                                                <input type="checkbox" name="item[]" value="{{$user->id}}" class="item_checkbox">
                                                <i></i>
                                            </label>
                                        </th>
                                        ...
                                        <td>   <a href="{{route('employee.user.show', $user)}}" class="js-ajax btn btn-sm btn-success btn-pill px-2 py-1 fs--15 ">{{__('Show')}}</a> </td>



                                        <td>   <a href="{{route('employee.user.show.edit', $user)}}" class="js-ajax btn btn-sm btn-primary btn-pill px-2 py-1 fs--15 ">{{__('Edit')}}</a> </td>



                                        <td>     <form action="{{route('employee.user.destroy', $user)}}" class="d-inline" method="post">
                                                @csrf
                                                {{method_field('DELETE')}}
                                            </form>
