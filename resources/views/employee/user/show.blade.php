                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <a href="{{route('employee.user.show.edit', $user)}}" class="js-ajax btn btn-sm btn-primary btn-pill px-2 py-1 fs--15 ">{{__('Edit')}}</a>



                                            </div>
                                            <div style="margin-right: 5px;margin-left: 5px" >
                                            <form action="{{route('employee.user.destroy', $user)}}" class="d-inline" method="post">
                                                @csrf
                                                {{method_field('DELETE')}}
                                            </form>
                                            </div>
