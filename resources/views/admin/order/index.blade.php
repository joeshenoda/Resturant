                                ...
                                <table class="table table-framed dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         <a href="{{route('admin.user.show',$order->user)}}">{{$order->user->name}}</a>
                                        </td>

                                        <!-- price -->
                                        <td>

                                            <a href="{{route('admin.table.show',$order->table)}}">{{$order->table->code}}</a>
                                        </td>
                                        ...
                                        <!-- options -->
                                        <td>   <a href="{{route('admin.order.show', $order)}}" class="js-ajax btn btn-sm btn-success btn-pill px-2 py-1 fs--15 ">{{__('Show')}}</a> </td>
