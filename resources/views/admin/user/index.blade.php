                ...
                <div class="portlet-body">
                    <div class="container py-6">
                        ...
                        <div class="card-header" style="width: auto">
                            ...
                            <a href="{{route('admin.user.create')}}" class="js-ajax btn btn-sm btn-success btn-pill px-2 py-1 fs--15 "><i class="fa fa-plus"></i><span >{{__('Create')}}</span></a>
                        </div>



                        <form action="{{route('admin.user.destroy_all')}}" id="form_data" class="d-inline" method="post">
                            @csrf
                            ...
                            <div class="table-responsive">
                                <table class="table table-framed dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <td>   <a href="{{route('admin.user.show', $user)}}" class="js-ajax btn btn-sm btn-success btn-pill px-2 py-1 fs--15 ">{{__('Show')}}</a> </td>



                                        <td>   <a href="{{route('admin.user.show.edit', $user)}}" class="js-ajax btn btn-sm btn-primary btn-pill px-2 py-1 fs--15 ">{{__('Edit')}}</a> </td>



                                        <td>     <form action="{{route('admin.user.destroy', $user)}}" class="d-inline" method="post">
                                                @csrf
                                                {{method_field('DELETE')}}
                                            </form>
