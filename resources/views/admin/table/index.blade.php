            ...
            <div class="portlet">
                ...
                <div class="portlet-header border-bottom">
                    ...
                    <div class="text-center" >
                        ...
                        <span > {{__('Total')}}      <span class=" badge badge-danger" > {{\App\Models\Tables::all()->count()}}</span></span>
                ...
                <div class="portlet-body">
                    <div class="container py-6">
                        ...
                        <div class="card-header" style="width: auto">
                            ...
                            <a href="{{route('admin.table.create')}}" class="js-ajax btn btn-sm btn-success btn-pill px-2 py-1 fs--15 "><i class="fa fa-plus"></i><span >{{__('Create')}}</span></a>
                        </div>



                        <form action="{{route('admin.table.destroy_all')}}" id="form_data" class="d-inline" method="post">
                            @csrf
                            ...
                            <div class="table-responsive">
                                <table class="table table-framed dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-gray-500 font-weight-normal fs--14 min-w-300"> {{__('Code')}}</th>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <label class="form-checkbox form-checkbox-primary float-start">
                                                <input type="checkbox" name="item[]" value="{{$table->id}}" class="item_checkbox">
                                                <i></i>
                                            </label>
                                        </th>
                                        ...
                                        <!-- options -->
                                        <td>   <a href="{{route('admin.table.show', $table)}}" class="js-ajax btn btn-sm btn-success btn-pill px-2 py-1 fs--15 ">{{__('Show')}}</a> </td>



                                        <td>   <a href="{{route('admin.table.show.edit', $table)}}" class="js-ajax btn btn-sm btn-primary btn-pill px-2 py-1 fs--15 ">{{__('Edit')}}</a> </td>



                                        <td>     <form action="{{route('admin.table.destroy', $table)}}" class="d-inline" method="post">
                                                @csrf
                                                {{method_field('DELETE')}}
                                            </form>
