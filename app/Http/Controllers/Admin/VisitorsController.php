...
class VisitorsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.visitor.index')->with('orders', $orders)->with('date',$date);
    }
    ...
    public function get_table()
    {
        ...
        return view('admin.visitor.table_check');
    }
    public function table_check(Request $request)
    {
        ...
        if(($request->input('end_time') > "12:00" && $request->input('end_time') < "23:59" && $request->input('start_time') > "12:00" && $request->input('start_time') < "23:59")){
            ...
            return view('admin.visitor.table_check')->with('tables', $tables)->with('date',$date)->with('chairs',$chairs)->with('start_time',$start_time)->with('end_time',$end_time);
